...
function GeneratingStatusBar({
  ...
  const statusConfig: Record<string, { color: string; label: string }> = {
    ...
    awaiting_response: {
      ...
      label: t("generating.awaitingResponse"),
    },
    reasoning: {
      color: tokens.colors.accent.purple,
      label: t("generating.thinking"),
    },
    generating: {
    ...
    applying: {
      ...
      label: t("generating.applying"),
    },
    compressing: {
      color: tokens.colors.accent.orange,
      label: t("generating.compacting"),
    },
  ...
  const statusLabel =
    status === "awaiting_response" && isInformativeStatus
      ? workerStatus
      : config.label;
