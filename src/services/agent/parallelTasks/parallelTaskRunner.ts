...
function buildTaskSystemPrompt(
  ...
  return [
    ...
    '- If you genuinely need the developer (a stack/auth/deploy choice, or credentials for a service), use ask_user_question / request_credentials — the developer is notified on your task row and answers in your task chat. Do not invent a house stack. Minor details: proceed and state the assumption.',
