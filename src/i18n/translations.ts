...
const en = {
  ...
  'speed.enabled': 'TM Speed is ON. Future agent requests use MiMo UltraSpeed and consume 3x tokens.',
  'speed.disabled': 'TM Speed is OFF. Future agent requests use your plan default routing.',
...
const pt: Record<keyof typeof en, string> = {
  ...
  'speed.enabled': 'TM Speed está ON. Os próximos pedidos do agente usam MiMo UltraSpeed e consomem 3x tokens.',
  'speed.disabled': 'TM Speed está OFF. Os próximos pedidos do agente usam o routing padrão do teu plano.',
